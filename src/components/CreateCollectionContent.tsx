...
export default function CreateCollectionContent() {
  ...
  return (
    <div className="create-collection-page">
      {/* Left Panel - AWS Branding */}
      <div className="create-collection-sidebar">
        <div className="aws-brand">
          <div className="aws-icon">
            <svg width="20" height="12" viewBox="0 0 24 14" fill="white">
      ...
      <div className="create-collection-main">
        <div className="create-collection-header">
          <div className="breadcrumb">
            ...
            <span className="breadcrumb-separator">/</span>
            <span className="breadcrumb-item active">OpenSearch Serverless</span>
          </div>
          <h1 className="page-title">Create Collection</h1>
          <p className="page-description">Set up your new Amazon OpenSearch Serverless collection.</p>
        </div>
        ...
        <div className="project-selector-section">
          <div className="project-badge">
            ...
            <span>aws-sa-partner-sandbox</span>
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            />
            <p className="form-hint">This is how we call your Collection in the Vercel dashboard and in AWS.</p>
          </div>
          ...
          <div className="plan-section">
            <h3 className="plan-title">Paid account plan</h3>
            <p className="plan-description">
              Pay-as-you-go after credits are consumed. You can manage the plan in the{' '}
              <a href="#" className="link-bold">Installation Settings</a>. Selected plan applies across all products.
            </p>
            ...
            <div className="pricing-card">
              <div className="pricing-header">
                ...
                <p>Start with $100 USD credits for up to 6 months. Credits are consumed based on the product rates.</p>
              </div>
              ...
              <div className="pricing-rows">
                ...
                <div className="pricing-row alt">
                  <span>Indexing Cost</span>
                  <span>$0.24 per OCU hour</span>
                </div>
                <div className="pricing-row">
                  <span>Search and Query Cost</span>
                  <span>$0.24 per OCU hour</span>
                </div>
                <div className="pricing-row alt">
                  <span>Storage Cost</span>
                  <span>$0.024 USD per GB-month (Serverless Standard)</span>
                </div>
              </div>

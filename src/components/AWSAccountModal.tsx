...
interface AWSAccountModalProps {
  ...
  onSelectExistingAccount: () => void;
}

export default function AWSAccountModal({ 
  isOpen, 
  onClose, 
  onSelectNewAccount, 
  onSelectExistingAccount 
}: AWSAccountModalProps) {
    ...
    <>
      ...
      <div className="modal-container">
        <div className="modal-header">
          <h2 className="modal-title">Install AWS Resources</h2>
        </div>

        <div className="modal-content">
          {/* Create New AWS Account Option */}
          <div 
            className={`aws-option-card ${selectedOption === 'new' ? 'selected' : ''}`}
            onClick={() => setSelectedOption('new')}
          >
            <div className="aws-option-content">
              <div className="aws-icon-wrapper">
                <div className="aws-icon-circle">
                ...
                <div className="aws-badge-plus">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="white">
                    <path d="M6 2v8M2 6h8" stroke="white" strokeWidth="2" strokeLinecap="round"/>
                  </svg>
                </div>
              </div>
              <div className="aws-option-text">
                <h3>Create New AWS Account</h3>
                <p>Accept our Terms and Conditions in the next step and we will then create an AWS account on your behalf.</p>
              </div>
            </div>
            <div className="aws-option-radio">
              <input 
                type="radio" 
                name="awsOption" 
          ...
          {/* Link Existing AWS Account Option */}
          <div 
            className={`aws-option-card ${selectedOption === 'existing' ? 'selected' : ''}`}
          ...
          >
            <div className="aws-option-content">
              <div className="aws-icon-wrapper">
                ...
                <div className="aws-badge-link">
                  <svg width="12" height="12" viewBox="0 0 12 12" fill="white">
                    <path d="M8 3l3 3-3 3M11 6H1" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
              </div>
              <div className="aws-option-text">
                <h3>Link Existing AWS Account</h3>
                <p>If you already have an AWS account, you can grant Vercel access to that account in the next step.</p>
              </div>
            </div>
            <div className="aws-option-radio">
              <input 
